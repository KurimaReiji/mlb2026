...
const divisions = [
  ...
  { division: "AL West", teams: ["LAA", "HOU", "TEX", "ATH", "SEA"] },
...
const createGameResult = (obj) => {
  ...
  const home = { team: obj.home, score: score[1] };
  const road = { team: obj.road, score: score[0] };
  const sign = Math.sign(home.score - road.score);
...
const team_selector = (team) => (game) =>
  [game.home, game.road].map((t) => t.team.toUpperCase()).includes(team.toUpperCase());
